...
written (the ruling's own "60" reads "71" since the DEC-16 gap-fixture extension landed at
TE-14, vault `e6ea366` — corpus totals, not clause semantics, moved): **R3.1** all 71
fixtures load hermetically, lint green against schema v2.2, their IR
...
last clause asked that all of the `expected:` blocks compose into envelope models. Today 44
of the 71 do
